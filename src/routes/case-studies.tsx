...
export const Route = createFileRoute("/case-studies")({
  head: () =>
    seo({
      title: "دراسات الحالة",
      description:
        "تصفح قصص نجاح SpinesTech ومشاريع التحول الرقمي وأنظمة ERP التي نفذناها لعملائنا في الخليج العربي.",
      path: "/case-studies",
    }),
  component: Page,
});
          ...
          <Container clean>
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-full border border-secondary-fixed/30 bg-secondary/15 px-4 py-1.5 text-secondary-fixed font-label-md text-label-md mb-6">
                ...
                {locale === "ar" ? "معرض أعمالنا" : "Our work showcase"}
              </span>
                    ...
                    >
                      ...
                      <div className={`relative overflow-hidden ${isFeatured ? "h-64 lg:h-[420px]" : "h-64"}`}>
                        <img
                          ...
                          loading="lazy"
                        />
                        {/* gradient overlay always present at base, intensifies on hover */}
