        ...
        {isError && (
          <div className="pt-32 pb-24">
            ...
            >
              <StateFeedback
                type="error"
                message="حدث خطأ في تحميل بيانات المنتج."
                onRetry={refetch}
              />
            </Container>
          </div>
          ...
          <div className="pt-32 pb-24">
            ...
            >
              <StateFeedback
                ...
                message="لم نتمكن من العثور على هذا المنتج."
              />
            </Container>
          </div>
        )}
          ...
          <>
            ...
            <section className="relative min-h-[90vh] flex items-center bg-primary-container overflow-hidden">
              ...
              <div ref={heroRef} className="absolute inset-0 will-change-transform">
                <div
                  className="islamic-pattern absolute inset-0 opacity-[0.04] bg-repeat"
                ...
                />
                <div
                  className="absolute top-[40%] left-[35%] w-[300px] h-[300px] rounded-full"
                  style={{
                    background:
              ...
              <Container
                clean
                className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-32 pb-20"
              >
                {/* Back link */}
                <Link
                  to="/products"
                ...
                <div className="grid lg:grid-cols-12 gap-12 items-center">
                  ...
                  <div className="lg:col-span-7 space-y-8">
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      ...
                      {data.badge && (
                        <span
                          className="px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase border border-secondary/30 text-secondary bg-secondary/10"
                    ...
                    {/* Title */}
                    <h1
                      className="font-display-lg text-display-lg text-on-primary font-bold leading-tight"
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                      {data.features.map((f, i) => (
                        <span
                          key={i}
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-secondary/20 bg-secondary/8 text-on-primary text-sm"
                        >
                          <span
                  ...
                  <div className="lg:col-span-5 flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-sm">
                      {/* Main stats card */}
                      <div
                        className="rounded-3xl border border-secondary/20 bg-white/5 p-8 space-y-6"
                        style={{
                      ...
                      >
                        <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                          ...
                          <span
                            className="text-secondary text-sm font-bold tracking-wider uppercase"
                        ...
                        {[
                          ...
                          },
                          {
                            value: 72,
                            suffix: "س",
                            label: locale === "ar" ? "وقت التسليم للتشغيل" : "Go-live time (hrs)",
                          },
                          {
                            value: 24,
                            suffix: "/7",
                            label: locale === "ar" ? "دعم تقني متواصل" : "Technical support",
                          },
                        ].map((stat, i) => (
                          <div
                            key={i}
                            className="flex items-end justify-between border-b border-white/5 pb-4 last:border-0 last:pb-0"
                          >
              ...
              <section className="py-24 bg-background">
                ...
                >
                  <div ref={highlightsReveal.ref} className="space-y-16">
                    <div
                      className={`text-center max-w-2xl mx-auto transition-all duration-700 ${highlightsReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                    >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                      {data.highlights.map((h, i) => (
                        ...
                        >
                          ...
                          {/* Number indicator */}
                          <div
                            className="absolute bottom-4 left-4 text-7xl font-black text-outline-variant/10 select-none leading-none"
                            aria-hidden="true"
                          >
              ...
              <section className="py-24 bg-surface-container-low">
                ...
                >
                  <div ref={modulesReveal.ref} className="space-y-12">
                    <div
                      className={`text-center max-w-2xl mx-auto transition-all duration-700 ${modulesReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                    >
                      <span className="inline-block px-4 py-1.5 rounded-full bg-secondary/10 text-secondary text-sm font-bold mb-4">
                    ...
                    <div
                      className={`grid lg:grid-cols-12 gap-8 items-start transition-all duration-700 delay-200 ${modulesReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
                    >
                      {/* Module tabs */}
                      <div className="lg:col-span-4 space-y-2">
                        {data.modules.map((mod, i) => (
                          ...
                          >
                            ...
                            >
                              <span
                                className={`material-symbols-outlined text-[18px] ${activeModule === i ? "text-secondary" : "text-on-surface-variant"}`}
                                aria-hidden="true"
                                style={{ fontVariationSettings: "'FILL' 1" }}
                              >
                                {mod.icon}
                            ...
                            <span
                              className={`font-bold text-sm ${activeModule === i ? "text-on-primary" : "text-on-surface"}`}
                            >
                              {mod.title}
                            </span>
                            {activeModule === i && (
                              <span
                                className="material-symbols-outlined text-secondary text-[16px] mr-auto"
                                aria-hidden="true"
                              >
                          ...
                          <div className="bg-primary-container px-8 py-6 flex items-center gap-5">
                            ...
                            <div>
                              <div className="text-secondary text-xs font-bold tracking-widest uppercase mb-1">
                                {locale === "ar"
                                  ? `الوحدة ${activeModule + 1} من ${data.modules.length}`
                                  : `Module ${activeModule + 1} of ${data.modules.length}`}
                              </div>
                          ...
                          <div className="p-8 space-y-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                              {(data.techSpecs || []).slice(0, 3).map((spec, i) => (
                                <span
                                  key={i}
                                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/8 border border-secondary/15 text-on-surface text-xs"
                                >
                                  <span
              ...
              >
                <div ref={useCasesReveal.ref} className="grid md:grid-cols-2 gap-8">
                  ...
                  {data.useCases && data.useCases.length > 0 && (
                    <div
                      className={`transition-all duration-700 ${useCasesReveal.visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
                    >
                  ...
                  {data.techSpecs && data.techSpecs.length > 0 && (
                    <div
                      className={`transition-all duration-700 delay-150 ${useCasesReveal.visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
                    >
                      <div className="rounded-3xl border border-outline-variant/40 bg-surface-container-lowest p-8 h-full">
                        <div className="w-11 h-11 rounded-xl bg-secondary/10 flex items-center justify-center mb-6">
                          <span
            ...
            {data.integrations && data.integrations.length > 0 && (
              <section className="py-16 bg-surface-container-low">
                ...
                >
                  ...
                  >
                    <p
                      className="text-center text-on-surface-variant text-sm font-bold uppercase tracking-widest mb-8"
            ...
            <section className="py-24 bg-primary-container relative overflow-hidden">
              ...
              <Container
                clean
                className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop"
              >
                <div
                  ref={ctaReveal.ref}
                ...
                >
                  ...
                  <div className="flex flex-wrap justify-center gap-6 pt-4 text-on-primary-container opacity-60 text-sm">
                    {[
                      {
                        icon: "lock",
                        text: locale === "ar" ? "بيانات آمنة 100%" : "100% secure data",
                      },
                      {
                        icon: "cancel",
                        text: locale === "ar" ? "بدون التزام مسبق" : "No commitment required",
                      },
                      {
                        icon: "speed",
                        text: locale === "ar" ? "تشغيل خلال 72 ساعة" : "Live in 72 hours",
                      },
                    ].map((t, i) => (
